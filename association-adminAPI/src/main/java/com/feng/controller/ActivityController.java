...
public class ActivityController {
     ...
     * 获取活动地点统计信息
     */
    @ApiOperation(value = "获取活动地点统计信息", notes = "获取活动地点统计信息")
    @GetMapping("/statistics/site")
    public ResponseResult getSiteStatistics() {
        List<Map<String, Object>> siteStats = activityService.getSiteStatistics();
        return ResponseResultUtil.renderSuccess(siteStats);
    }

    /**
     * 获取比赛成果统计信息
     */
    @ApiOperation(value = "获取比赛成果统计信息", notes = "获取比赛成果统计信息")
    @GetMapping("/statistics/result")
    public ResponseResult getResultStatistics() {
        List<Map<String, Object>> resultStats = activityService.getResultStatistics();
        return ResponseResultUtil.renderSuccess(resultStats);
    }
}
