...
@Api(value = "协会管理系统后台文件管理文档接口",tags = "协会管理系统后台文件管理文档接口")
public class FileController {
    ...
    public ResponseResult saveEquipmentFile(@Valid @RequestBody File file) {
        file.setActivityId(0);
        file.setPassageId(0);
        if (file.getFileTypeId() == null) {
            file.setFileTypeId(FileEnum.EQUIPMENT_IMG.getFileId());
        }
