...
public class ActivityController {
    ...
    public ResponseResult list(@RequestParam(required = false) Integer activityTypeId, @RequestParam(defaultValue = "1") int pageNum, @RequestParam(defaultValue = "8") int pageSize) {
