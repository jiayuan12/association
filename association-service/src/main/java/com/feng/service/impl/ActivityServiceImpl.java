...
//    @CachePut(value = "activity", key = "#activity.id")
    ...
    public boolean deleteById(Serializable id) {
        ...
        //删除了活动如果有对应的图片还要删除对应的图片
        File file = fileMapper.selectByActivityId(id);
        if (file != null) {
    ...
    @Override
    public List<Map<String, Object>> getSiteStatistics() {
        return activityMapper.selectSiteStatistics();
    }

    @Override
    public List<Map<String, Object>> getResultStatistics() {
        return activityMapper.selectResultStatistics();
    }
}
